...
#
#echo "combine  CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -M MultiDimFit -n _bonlyForLoading_$EXT -t -1  --setParameters r_ggH_0J=0,r_ggH_1J_low=0,r_ggH_1J_med=0,r_ggH_1J_high=0,r_ggH_BSM=0,r_ggH_GE2J=0,r_qqH=0,r_ttH=0,r_QQ2HLNU=0,r_QQ2HLL=0,r_VH2HQQ=0 --saveWorkspace"
#combine  CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -M MultiDimFit -n _bonlyForLoading_$EXT -t -1  --setParameters r_ggH_0J=0,r_ggH_1J_low=0,r_ggH_1J_med=0,r_ggH_1J_high=0,r_ggH_BSM=0,r_ggH_GE2J=0,r_qqH=0,r_ttH=0,r_QQ2HLNU=0,r_QQ2HLL=0,r_VH2HQQ=0 --saveWorkspace
#
