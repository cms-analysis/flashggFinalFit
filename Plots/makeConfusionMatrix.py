...
h_matrix.GetXaxis().SetLabelSize(0.022)
...
#pm_lines = ['qqH_other','WH_lep','ZH_lep','ttH']#,'tHq']
#pm_lines = ['qqH_other','WH_lep','ZH_lep','ttH','tHq']
pm_lines = ['qqH_other','WH_lep_low','ZH_lep','ttH_low','tHq','bbH']
