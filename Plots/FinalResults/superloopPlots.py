...
mh_h = r.TH1F("mh","mh",20,-1,1)
mu_h = r.TH1F("mu","mu",20,-1,1)
pval_h = r.TH1F("pval","pval",20,-1,1)
c = r.TCanvas()
...
for line in d.readlines():
    ...
    if words[0]=="mh":
      ...
      mherrorsXLo = (0.)
      mherrorsXHi = (0.)
      mh.SetPoint(countermh,mhvalueX,mhvalue)
      mh.SetPointError(countermh,mherrorsXLo,mherrorsXHi,mherrorsLo,mherrorsHi)
      dmH=(mhvalue -125.)/(mherrorsLo+mherrorsHi)
      mh_h.Fill(dmH)
      print "MH: ",mherrorsLo ,", ", mhvalue ,", ", mherrorsHi, "deltaMh/sigma ",dmH
      countermh+=1
    if words[0]=="mu":
      ...
      mu.SetPoint(countermu,muvalueX,muvalue)
      mu.SetPointError(countermu,muerrorsXLo,muerrorsXHi,muerrorsLo,muerrorsHi)
      dmu=(muvalue -1.)/(muerrorsLo+muerrorsHi)
      mu_h.Fill(dmH)
      print "MU: ",muerrorsLo ,", ", muvalue ,", ", muerrorsHi, "dmu/sigma ", dmu
      countermu+=1
    ...
    if words[0]=="Observed_13TeV":
      ...
      pval_h.Fill(dpval)
      print " PVAL obs ", pobsval, ", exp ", pexpval, ", dpval ", dpval
