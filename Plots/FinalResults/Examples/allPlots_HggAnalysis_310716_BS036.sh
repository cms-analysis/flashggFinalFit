...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanFixMH125.97/MuScanFixMH125.97.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_TTHLeptonicTag_13TeV/r_TTHLeptonicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_TTHHadronicTag_13TeV/r_TTHHadronicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_VBFTag_1_13TeV/r_VBFTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_VBFTag_0_13TeV/r_VBFTag_0_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_UntaggedTag_3_13TeV/r_UntaggedTag_3_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_UntaggedTag_2_13TeV/r_UntaggedTag_2_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_UntaggedTag_1_13TeV/r_UntaggedTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH125.97/r_UntaggedTag_0_13TeV/r_UntaggedTag_0_13TeV.root --perprocchcomp -x -3,8.5 -o PerTagChannelCompatibilityFixMH125.97 --do1sig  -l 0.55,0.65,0.85,0.90 --text="    ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)"  --mhval "125.97"  -b
...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanFixMH125.97/MuScanFixMH125.97.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH125.97/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH125.97/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH125.97/r_ggH/r_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityFixMH125.97 --do1sig  -l 0.55,0.65,0.9,0.9 --text="${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)"  --mhval "125.97" --MHtext 0.57:0.41:"#bf{#mu_{VH}=1}"   -b

##########################################
#########  MUHAT vs MH 1D Scans ##########
##########################################
./makeCombinePlots.py -f combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/120.00/120.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/121.00/121.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/122.00/122.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/123.00/123.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/124.00/124.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/125.00/125.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/126.00/126.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/127.00/127.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/128.00/128.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/129.00/129.00.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/120.50/120.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/121.50/121.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/122.50/122.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/123.50/123.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/124.50/124.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/125.50/125.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/126.50/126.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/127.50/127.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/128.50/128.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/129.50/129.50.root,combineJobs13TeV_${EXT}/MultiPdfMuHatvsMH/130.00/130.00.root --mpdfmaxlh -x 120,130 -y -0.6,2.2 -o MuHat_vs_MH --do1sig  -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" --legend 0.12,0.72,0.49,0.80 -b 
##########################################
##########  RV vs RF 2D SCANS   ##########
##########################################
...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/RVRFScanProfileMH/RVRFScanProfileMH.root --rvrf -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o RVRFScanProfileMH_Run1Ranges --xbinning 51,-0.99,3.49 --ybinning 20,-0.49,3.49 --MHtext 0.17:0.16:"#scale[0.9]{m_{H} Profiled}" --legend 0.71,0.65,0.89,0.89 -b 
...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/CVCFScanProfileMH/CVCFScanProfileMH.root --cvcf -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o CVCFScanProfileMH --xbinning 30,0,2 --ybinning 40,-1,3 --MHtext 0.13:0.8:"m_{H} Profiled" --legend 0.13,0.5,0.3,0.75 -b --addSM 
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/CVCFScanProfileMH_granular/CVCFScanProfileMH_granular.root --cvcf -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o CVCFScanProfileMH_granular --xbinning 70,0,2 --ybinning 114,-1,3 --MHtext 0.13:0.83:"H#rightarrow#gamma#gamma":0.055 --MHtext 0.13:0.78:"m_{H} Profiled":0.035 --legend 0.115,0.55,0.3,0.75 -b --addSM --box 0.1,0.55,0.3,0.9,0 
##########################################
...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/KGluKGamScanProfileMH/KGluKGamScanProfileMH.root --kglukgam -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o KGluKGamScanProfileMH --xbinning 25,0,2 --ybinning 25,0,2 --MHtext 0.13:0.8:"m_{H} Profiled" --legend 0.13,0.5,0.3,0.75 --addSM -b 
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/KGluKGamScanProfileMH_granular/KGluKGamScanProfileMH_granular.root --kglukgam -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o KGluKGamScanProfileMH_granular --xbinning 94,0,2 --ybinning 94,0,2  --MHtext 0.66:0.83:"H#rightarrow#gamma#gamma":0.055 --MHtext 0.66:0.78:"m_{H} Profiled":0.035 --legend 0.63,0.55,0.85,0.75 -b --addSM --box 0.63,0.55,0.85,0.9,0 
