...
parser.add_option("-L","--mHlow",dest="mHlow",type="float",default=115,help="Lowest MH")
parser.add_option("-H","--mHhigh",dest="mHhigh",type="float",default=135,help="Highest MH")
