...
./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScan/ExpMuScan.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/r_ggH/r_ggH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/r_VH/r_VH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)" --mhval "Profiled"  -b
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScanStat/ExpMuScanStat.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_ggH/r_ggH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_VH/r_VH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV), STAT ONLY" --mhval "Profiled"  -b
