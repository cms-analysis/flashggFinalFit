...
./makeCombinePlots.py -f combineJobs13TeV_$EXT/RVRFScanProfileMH/RVRFScanProfileMH.root --rvrf -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o RVRFScanFixMH --xbinning 50,-1.,3. --ybinning 50,-1.,3. --MHtext 0.17:0.17:"m_{H}=125.09 GeV" --legend 0.68,0.63,0.82,0.87 -b 
