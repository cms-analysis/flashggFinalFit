...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanProfileMH_v2/MuScanProfileMH_v2.root --mu -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" --MHtext 0.17:0.7:"m_{H} Profiled" -o MuScanProfileMH  -b #RooRealVar::MH = 125.973 +/- 0.292702  L(115 - 135) // [GeV]
...
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanFixMH/MuScanFixMH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_TTHLeptonicTag_13TeV/v0_TTHLeptonicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_TTHHadronicTag_13TeV/v0_TTHHadronicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_VBFTag_1_13TeV/v0_VBFTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_VBFTag_0_13TeV/v0_VBFTag_0_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_UntaggedTag_3_13TeV/v0_UntaggedTag_3_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_UntaggedTag_2_13TeV/v0_UntaggedTag_2_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_UntaggedTag_1_13TeV/v0_UntaggedTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityFixMH/v0_UntaggedTag_0_13TeV/v0_UntaggedTag_0_13TeV.root --perprocchcomp -x -3,8.5 -o PerTagChannelCompatibilityFixMH --do1sig  -l 0.55,0.65,0.85,0.90 --text="    ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)"  --mhval "125.09"  -b
./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanProfileMH/MuScanProfileMH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_TTHLeptonicTag_13TeV/v0_TTHLeptonicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_TTHHadronicTag_13TeV/v0_TTHHadronicTag_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_VBFTag_1_13TeV/v0_VBFTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_VBFTag_0_13TeV/v0_VBFTag_0_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_UntaggedTag_3_13TeV/v0_UntaggedTag_3_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_UntaggedTag_2_13TeV/v0_UntaggedTag_2_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_UntaggedTag_1_13TeV/v0_UntaggedTag_1_13TeV.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/v0_UntaggedTag_0_13TeV/v0_UntaggedTag_0_13TeV.root --perprocchcomp -x -3,8.5 -o PerTagChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.90 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)"  --mhval "Profiled"  -b

##########################################
#########  PER PROC CH COMP ##############
##########################################

#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanProfileMH/MuScanProfileMH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/v3_ttH/v3_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/v3_qqH/v3_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityProfileMH/v3_ggH/v3_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)" --MHtext 0.57:0.41:"#bf{#mu_{VH} = 1}"  --mhval "Profiled"  -b
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanFixMH/MuScanFixMH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH/v3_ttH/v3_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH/v3_qqH/v3_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH/v3_ggH/v3_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityFixMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="       ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)" --MHtext 0.57:0.41:"#bf{#mu_{VH}=1}"   --mhval "125.09"  -b
#
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/MuScanFixMH125.97/MuScanFixMH125.97.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH125.97/v3_ttH/v3_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH125.97/v3_qqH/v3_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityFixMH/v3_ggH/v3_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityFixMH125.97 --do1sig  -l 0.55,0.65,0.9,0.9 --text="${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)"  --mhval "125.97"  -b
