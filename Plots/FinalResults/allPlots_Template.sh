...
#
./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScan/ExpMuScan.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_bbH/r_bbH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_VH/r_VH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_ggH/r_ggH.root --perprocchcomp -x -2,9 -o PerTagChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)" --mhval "Profiled"  -b
#./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScan/ExpMuScan.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_VH2HQQ/r_VH2HQQ.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_QQ2HLL/r_QQ2HLL.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_QQ2HLNU/r_QQ2HLNU.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerTagChannelCompatibilityProfileMH/r_ggH/r_ggH.root --perprocchcomp -x -2,9 -o PerTagChannelCompatibilityProfileMH --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV)" --mhval "Profiled"  -b
#
