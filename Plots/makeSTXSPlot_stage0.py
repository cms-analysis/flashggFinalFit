...
if "obs" in opt.inputJson:
  canv.SaveAs("/eos/home-j/jlangfor/www/CMS/hgg/stxs_runII/Jul20/pass0/checks/stxs_summary_%s_obs.pdf"%opt.mode)
  canv.SaveAs("/eos/home-j/jlangfor/www/CMS/hgg/stxs_runII/Jul20/pass0/checks/stxs_summary_%s_obs.png"%opt.mode)
else:
  canv.SaveAs("/eos/home-j/jlangfor/www/CMS/hgg/stxs_runII/Jul20/pass0/checks/stxs_summary_%s_exp.pdf"%opt.mode)
  canv.SaveAs("/eos/home-j/jlangfor/www/CMS/hgg/stxs_runII/Jul20/pass0/checks/stxs_summary_%s_exp.png"%opt.mode)
