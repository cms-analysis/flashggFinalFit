...
proc_x_stxs_x_era=(  'THQ_FID' 'ZH2HQQ_FWDH')
length=${#proc_x_stxs_x_era[@]}

for ((i=0;i<length;i++)); do python3 trees2ws.py --inputConfig config_tutorial.py --inputTreeFile /eos/user/p/pkrueper/STXS_test/run3hggstxs_1p2/src/run3hggstxs/postprocessing/18sep_signalTESTT/postEE/${proc_x_stxs_x_era[i]}/nominal  --inputMass 125 --productionMode ${proc_x_stxs_x_era[i]}  --year postEE --doSystematics --skiplength 100000 --reduceprocs ['THQ_FID'];done
