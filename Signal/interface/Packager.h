...
class Packager {
  ...
  public:
    ...
    Packager(RooWorkspace *ws, std::vector<std::string> procs, int nCats, int mhLow, int mhHigh, std::vector<int> skipMasses, int sqrts=-1, bool skipPlots=false, string outDir="plots",
