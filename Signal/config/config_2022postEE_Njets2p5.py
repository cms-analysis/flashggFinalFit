...
signalScriptCfg = {
  ...
  'ext':'Run3FidXSAnalysis_Njets2p5_2022postEE', # output directory extension
  'analysisRM': 'Run3FidXSAnalysisNJ' # To specify replacement dataset (defined in ./commonTools/replacementMap.py)
