...
signalScriptCfg = {
  ...
  'ext':'Run3FidXSAnalysis_rapidity_2022postEE', # output directory extension
  'analysisRM': 'Run3FidXSAnalysisYH' # To specify replacement dataset (defined in ./commonTools/replacementMap.py)
