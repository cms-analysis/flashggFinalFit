...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/vols/cms/jl2117/hgg/ws/Feb20_unblinding/stage1_2_%s/tagsettwo'%_year, 
  ...
  #'cats':'RECO_VBFTOPO_JET3VETO_LOWMJJ_Tag1',
  'ext':'stage1_2_tagsettwo_%s'%_year,
  'analysis':'stage1_2_ts2', # To specify which replacement dataset mapping (defined in ./python/replacementMap.py)
  'year':'%s'%_year, 
  'beamspot':'3.4',
  'numberOfBins':'320',
