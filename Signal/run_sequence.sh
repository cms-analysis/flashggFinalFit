...
if [[ $STEP == "fTest" ]] || [[ $STEP == "calcPhotonSyst" ]] || [[ $STEP == 'signalFit' ]]; then
  ...
  echo "packager"  
     python RunPackager.py --cats "auto" --inputWSDir /cmshome/fderiggi/CMSSW_10_2_13/src/flashggFinalFit/Signal/cards/signal_2017 --outputExt packaged --exts 2023-02-13_year2016preVFP,2023-02-13_year2016postVFP,2023-02-13_year2017,2023-02-13_year2018 --mergeYears --batch Rome --queue cmsan ${DROPT}
