...
int main(int argc, char *argv[]){
        ...
        std::cout << "ED DEBUG:: OK, in pho sys main" << std::endl;
	...
	//	inWS_ = (RooWorkspace*)inFiles[0]->Get("tagsDumper/cms_hgg_13TeV"); //FIXME should add all workspaces together from various files
        std::cout << "ED DEBUG:: in pho sys main, opened files" << std::endl;
        std::cout << "ED DEBUG:: infilenamesStr_ = " << infilenamesStr_ << std::endl;
	inWS_ = new WSTFileWrapper(infilenamesStr_,"tagsDumper/cms_hgg_13TeV");
        std::cout << "ED DEBUG:: in pho sys main, got worksapce" << std::endl;

	ofstream outfile;
	outfile.open(outfilename_.c_str());
	if (verbosity_)	cout << "[INFO] Writing to datfile " << outfilename_ << endl;
        std::cout << "ED DEBUG:: in pho sys main, opened outfile" << std::endl;
	...
	outfile << "# photonCat                   mean_change    sigma_change    rate_change" << endl;
        ...
        std::cout << "ED DEBUG:: in pho sys main, done all file business, about to loop over cats" << std::endl;
	...
	outfile.close();
        ...
        std::cout << "ED DEBUG:: end of pho sys main" << std::endl;
