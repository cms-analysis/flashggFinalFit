...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/vols/cms/jl2117/hgg/ws/Feb20_unblinding/stage1_2_%s/tagsetthree'%_year, 
  ...
  #'cats':'RECO_TTH_HAD_LOW_Tag0',
  'ext':'stage1_2_tagsetthree_%s'%_year,
  'analysis':'stage1_2_ts3', # To specify which replacement dataset mapping (defined in ./python/replacementMap.py)
  'year':'%s'%_year, 
  'beamspot':'3.4',
  'numberOfBins':'320',
