python RunYields.py --cats auto --inputWSDirMap 2016=cards/cards_current/signal_2016,2017=cards/cards_current/signal_2017,2018=cards/cards_current/signal_2018 --procs auto --mergeYears --doSystematics --ext 2022-04-12 --batch condor --queue espresso --printOnly
