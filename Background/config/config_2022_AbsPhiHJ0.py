...
backgroundScriptCfg = {
  ...
  # Setup
  'inputWS':'../input_output_data_AbsPhiHJ0_2022/ws/allData.root', # location of 'allData.root' file
  'cats':'auto', # auto: automatically inferred from input ws
  'catOffset':0, # add offset to category numbers (useful for categories from different allData.root files)  
  'ext':'earlyAnalysis_AbsPhiHJ0', # extension to add to output directory
