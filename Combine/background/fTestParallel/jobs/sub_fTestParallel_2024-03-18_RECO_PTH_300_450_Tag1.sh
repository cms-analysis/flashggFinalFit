...
/mnt/cmsrm-home01.roma1.infn.it/cmshome/fderiggi/CMSSW_10_2_13/src/flashggFinalFit/Background/runBackgroundScripts.sh -i data/data_all/ws//allData.root -p none -f RECO_PTH_300_450_Tag1 --ext 2024-03-18 --catOffset 27 --intLumi 138 --year all --batch Rome --queue cmsan --sigFile none --isData --fTest
