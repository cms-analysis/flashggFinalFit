...
#cmdLine = "plot1DScan.py ./runFits%s_%s/profile1D_syst_%s.root --y-cut 20 --y-max 20 --output ./runFits%s_%s/Plots/profile1D_%s%s --POI %s --translate ../Plots/pois_minimal.json --main-label Expected --main-color 1 --others ./runFits%s_%s/profile1D_statonly_%s.root:\"Stat. only\":1 --logo-sub \"Preliminary\" --breakdown Syst,Stat"%(opt.ext,opt.mode,opt.POI,opt.ext,opt.mode,opt.POI,opt.ext,opt.POI,opt.ext,opt.mode,opt.POI)

cmdLine = "plot1DScan.py ./runFits%s_%s/profile1D_syst_obs_%s.root --y-cut 20 --y-max 20 --output ./runFits%s_%s/Plots/profile1D_%s_obs%s --POI %s --translate ../Plots/pois_intermediate.json --main-label Observed --main-color 1 --others ./runFits%s_%s/profile1D_statonly_ss_obs_%s.root:\"Stat. only\":1 --logo-sub \"Preliminary\" --breakdown Syst,Stat"%(opt.ext,opt.mode,opt.POI,opt.ext,opt.mode,opt.POI,opt.ext,opt.POI,opt.ext,opt.mode,opt.POI)
...
#cmdLine = "plot1DScan.py ./runFits%s_%s/profile1D_syst_obs_%s.root --y-cut 20 --y-max 20 --output ./runFits%s_%s/Plots/profile1D_%s_obs%s --POI %s --translate ../Plots/pois_mu.json --main-label Observed --main-color 1 --others ./runFits%s_%s/profile1D_removeTHU_ss_obs_%s.root:\"Remove th. unc\":2  ./runFits%s_%s/profile1D_statonly_ss_obs_%s.root:\"Stat. only\":1 --logo-sub \"Preliminary\" --breakdown Th,Exp,Stat"%(opt.ext,opt.mode,opt.POI,opt.ext,opt.mode,opt.POI,opt.ext,opt.POI,opt.ext,opt.mode,opt.POI,opt.ext,opt.mode,opt.POI)
