...
python /mnt/cmsrm-home01.roma1.infn.it/cmshome/fderiggi/CMSSW_10_2_13/src/flashggFinalFit/Signal/scripts/packageSignal.py --cat RECO_0J_PTH_GT10_Tag0 --outputExt packaged --massPoints 120,125,130 --exts 2023-02-13_year2016preVFP,2023-02-13_year2016postVFP,2023-02-13_year2017,2023-02-13_year2018 --mergeYears
